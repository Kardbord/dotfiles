...
-- Check out www.nerdfonts.com for some cool fonts patched with extra icons.
-- To install a font:
--  1. place the ttf file(s) in /usr/local/share/fonts/
--  2. fc-cache -f -v /usr/local/share/fonts/
--  3. fc-list | grep "<name-of-font>"
-- Note that if you're using another application to launch your terminal,
-- such as MobaXterm, then you need to have the font installed and activated
-- on the system running that application.
...
-- [[ Configure Treesitter ]] See `:help vim.treesitter`
vim.treesitter.config.setup({
  ensure_installed = {
    'bash',
    'c',
    'cpp',
